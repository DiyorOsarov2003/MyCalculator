...
const App = () => {
    ...
    const clearAll = () => { // clear all numbers
        return setResult("");
    }
    const backspace = () => { // / backspace function 
        return setResult(result.slice(0, -1))
    }
    const calculate = () => { // eval method for calculate and if you write wrong, return wrong input
        try {
        ...
        <div className="container">
            ...
            <div className="touch-btn">
                ...
                <button className="effect" name="+" onClick={touchClick}>+</button>
                    ...
                    <button className="effect" name="-" onClick={touchClick}>&ndash;</button>
